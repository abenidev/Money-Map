...
class _IncomeAddPageState extends ConsumerState<IncomeAddPage> {
  ...
  void initState() {
    ...
    afterBuildCreated(() {
      ...
      List<Category> incomeCategories = ref.read(categoriesViewmodelProvider.notifier).getIncomeCategories();
      if (incomeCategories.isEmpty) throw Exception('Categories cannot be empty at this state!');
      ref.read(selectedCategoryProvider.notifier).state = incomeCategories[0];
    });
  }
  ...
  Widget build(BuildContext context) {
    List<Category> categories = ref.watch(categoriesViewmodelProvider.notifier).getIncomeCategories();
